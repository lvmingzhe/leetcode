...
这道题有重复元素，所以核心问题是去重复。去重需要先排序，要不然用map或者set效率很低。
去重讲解最清晰的是代码随想录[第40题组合综合II题解](https://mp.weixin.qq.com/s?__biz=MzUxNjY5NTYxNA==&mid=2247485360&idx=1&sn=2256a0f01a304d82a2b59252327f3edb&scene=21#wechat_redirect)
